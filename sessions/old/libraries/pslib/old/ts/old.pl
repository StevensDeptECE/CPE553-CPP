...
sub graph {
  ...
  $gt .= drawTicks($ymin, $yinc, $ymax, $x0pts, $x0pts + $xTickSize, $yScale, $yOffset, "ytick");
  $gt .= drawTicks($ymin, $yinc, $ymax, $x1pts, $x1pts - $xTickSize, $yScale, $yOffset, "ytick");
...
lineplot($gt, $x, $y, $styleSolidBlack);
markerplot($gt, $x, $y, $styleSolidBlue, 4, 'markerx');
